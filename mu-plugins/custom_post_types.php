<?php
    ...
    function cptui_register_my_cpts_oportunities() {
    ...
    function cptui_register_my_cpts_story() {
    ...
    add_action( 'init', 'cptui_register_my_cpts_oportunities' );
    add_action( 'init', 'cptui_register_my_cpts_story' );
