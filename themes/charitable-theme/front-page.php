        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h6 class="section-title text-start text-primary text-uppercase">Rationale</h6>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-start text-primary text-uppercase">Featured</h6>
                    <h1 class="mb-5">Press Releases</h1>
                </div>
                <div class="row g-4">
                        <?php
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="">
                            ...
                            <p class="text-body mb-0"><?php the_content(); ?></p>
                        </a>
                    </div>
...
<div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h6 class="section-title text-start text-primary text-uppercase">Statistics</h6>
                        <h1 class="mb-4">Earthquake disaster in <span class="text-primary text-uppercase">Numbers</span></h1>
                        <p class="mb-4">Over 50,000 people have tragically lost their lives. Over 100,000 people have been seriously injured and thousands of families have been left homeless in the bitter cold.
                            <br><br> CHARITABLE teams are working on the ground in Turkey and Syria with local communities to provide:
                            <br><br> <i class="fa fa-solid fa-arrow-right text-primary mb-2"></i>   Shelter, blankets and heating for people who have lost their homes
                            <br><br> <i class="fa fa-solid fa-arrow-right text-primary mb-2"></i>   Food and clean water to ensure families can survive the winter
                            <br><br> <i class="fa fa-solid fa-arrow-right text-primary mb-2"></i>   Healthcare and psychosocial support for communities affected </p>
                    </div>
